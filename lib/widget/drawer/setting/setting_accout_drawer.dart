...
class SettingAccoutDrawer extends StatelessWidget {
  @override
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Appbar(context),
          buildListContainer(context, "Message_alt_fill.png", "เปลี่ยน Email"),
          buildListContainer(context, "Key_fill.png", "เปลี่ยนรหัสผ่าน"),
          buildListContainer(
              context, "Transger.png", "การเชื่อมต่อกับแพลตฟอร์ม"),
          buildListContainer(context, "Cancel_fill.png", "ระงับบัญชี"),
        ],
      ),
    );
  }
