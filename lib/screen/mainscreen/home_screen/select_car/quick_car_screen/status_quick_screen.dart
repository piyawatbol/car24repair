...
class StatusQuickScreen extends StatefulWidget {
  String? request_id;
  StatusQuickScreen({required this.request_id});

  @override
  State<StatusQuickScreen> createState() => _StatusQuickScreenState();
}

class _StatusQuickScreenState extends State<StatusQuickScreen> {
