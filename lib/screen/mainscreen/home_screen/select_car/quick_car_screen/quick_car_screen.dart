import 'dart:convert';
import 'package:car24repair/screen/mainscreen/home_screen/select_car/quick_car_screen/problem_screen.dart';
...
class QuickCarScreen extends StatefulWidget {
  QuickCarScreen({Key? key}) : super(key: key);

  @override
  State<QuickCarScreen> createState() => _QuickCarScreenState();
}

class _QuickCarScreenState extends State<QuickCarScreen> {
  String? user_id;
  List carList = [];
